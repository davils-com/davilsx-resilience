...
public object Project {
    ...
    public object Identity {
         ...
         * @since 1.0.0
         */
        public const val INCEPTION_YEAR: Int = 2026
    }
    ...
    public object VersionControl {
        ...
        /**
         * The URL of the continuous integration system.
         *
         * @since 1.0.0
         */
        public const val CI_URL: String = "https://github.com/davils-com/davilsx-resilience/actions"

        /**
         * The read-only connection URL for source control management.
         *
         * @since 1.0.0
         */
        public const val SCM_CONNECTION: String = "scm:git:https://github.com/davils-com/davilsx-resilience.git"

        /**
         * The developer connection URL for source control management.
         *
         * @since 1.0.0
         */
        public const val SCM_DEVELOPER_CONNECTION: String = "scm:git:ssh://git@github.com:davils-com/davilsx-resilience.git"
         ...
         * @since 1.0.0
         */
        public const val SCM_URL: String = "https://github.com/davils-com/davilsx-resilience.git"
    }

    /**
     * Contains constants related to legal and licensing information.
     *
     * @since 1.0.0
     */
    public object Legal {
         ...
         * @since 1.0.0
         */
        public const val LICENSE_URL: String = "https://github.com/davils-com/davilsx-resilience/blob/main/LICENSE"
    ...
    /**
     * Contains constants related to issue tracking and management.
     *
     * @since 1.0.0
     */
    public object IssueManagement {
         ...
         * @since 1.0.0
         */
        public const val URL: String = "https://github.com/davils-com/davilsx-resilience/issues"
    }

    /**
     * Contains constants related to Android SDK configuration.
     *
     * @since 1.0.0
     */
    public object Android {
        /**
         * The Android SDK version used for compilation.
         *
         * @since 1.0.0
         */
         ...
         * @since 1.0.0
         */
        public const val MIN_SDK: Int = 26
    }
}
