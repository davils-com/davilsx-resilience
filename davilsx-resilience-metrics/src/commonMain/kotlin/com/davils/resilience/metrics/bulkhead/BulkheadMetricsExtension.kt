...
public fun Bulkhead.metrics(block: BulkheadMetricsCollector.() -> Unit): BulkheadMetricsCollector = metrics.apply(block)

public fun Bulkhead.metrics(): BulkheadMetricsCollector = metrics
